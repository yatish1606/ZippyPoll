                    ...
                    !pollSuccess ?
                        ...
                        <div className="flex h-full w-full flex-col items-center">
                            ...
                            <div className="h-full w-full flex flex-col items-center justify-center px-16">
                                <p className="text-2xl text-center font-bold text-slate-700">Poll created successfully</p>
                                <div className="h-6"></div>
                                <p className="text-sm text-center font-normal text-slate-500 tracking-wide">Your poll is now {isPublic ? 'available to view and vote for everyone' : 'available to view and vote with those who you share the link with'}</p>
                                <div className="h-12"></div>
                                <div className="flex items-center">
                                    <ButtonPrimary title='View Poll' />
                                    <div className="w-3"></div>
                                    <ButtonSecondary title='Go Back' onClick={() => {
                                        canShow = false
                                        updateModalState()
